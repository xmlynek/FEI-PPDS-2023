...
class Shared(object):
    ...
    Attributes:
        ...
        customer: Semaphore to provide customer - barber rendezvous.
        barber: Semaphore to provide barber - customer rendezvous.
        customer_done: Semaphore which forms rendezvous with barber_done.
        barber_done: Semaphore which forms rendezvous with customer_done.
    """
